      ...
      <div class="container">
        <div class="row text-center">
		   <div class="text-center mx-auto col-10">
			<h2> PRODUCTOS POR PAIS</h2>
         <form method="GET" action="productosdelpaiss.php" class="form-inline mb-3">
</form>	
		   </div>		
		</div>	
		<div class="row text-center">	
            ...
            $tabla="productosdelpais";// Escribir entre comillas el nombre de la tabla a listar
...
echo '	  <a class="page-link" href="productosdelpais.php?pagina='.$anterior.$paramBusqueda.'">&laquo;</a>';
			echo '	</li>';
			for ($i=1;$i<=$numpag;$i++)
            {
                if($i==$pagina){
						echo '	<li class="page-item active">';
						echo '	  <a class="page-link" href="productosdelpais.php?pagina='.$i.$paramBusqueda.'">'.$i.'</a>';
						echo '	</li>';						
					}
                    else{
						echo '	<li class="page-item"><a class="page-link" href="productosdelpais.php?pagina='.$i.'">'.$i.'</a></li>';
                    }
            }
			echo '	<li class="page-item ">';
			echo '	  <a class="page-link" href="productosdelpais.php?pagina='.$siguiente.$paramBusqueda.'">&raquo;</a>';
			echo '	</li>';
			echo '  </ul>';
