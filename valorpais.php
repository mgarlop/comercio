...
echo '	  <a class="page-link" href="valorpais.php?pagina='.$anterior.$paramBusqueda.'">&laquo;</a>';
			echo '	</li>';
			for ($i=1;$i<=$numpag;$i++)
            {
                if($i==$pagina){
						echo '	<li class="page-item active">';
						echo '	  <a class="page-link" href="valorpais.php?pagina='.$i.$paramBusqueda.'">'.$i.'</a>';
						echo '	</li>';						
					}
                    else{
			...
			echo '	<li class="page-item ">';
			echo '	  <a class="page-link" href="valorpais.php?pagina='.$siguiente.$paramBusqueda.'">&raquo;</a>';
			echo '	</li>';
			echo '  </ul>';
